...
var fcupUpload = {
    ...
    createHtml:function(){
        if($(".upload-mask").length<=0){
            $("body").before(' <link rel="stylesheet" href="/css/upload/upload.css"><script src="/js/upload/jquery.fcup.js"></script>');
...
//    fc分片上传初始化
    fcupInit:function (domId,upShardSize,upMaxSize,upType,fcupUploadCallback) {
        fcupUpload.createHtml();
        ...
        $.fcup({
            ...
            upUrl: '/upload/index/upload', //文件上传接口
