...
class PHP_Token_ClassTest extends TestCase
{
    ...
    public function testSomething()
    {
        ...
        $this->assertSame(5, $classes['Zero']['methods']['even']['startLine']);
        $this->assertSame(12, $classes['Zero']['methods']['even']['endLine']);

        $this->assertSame(7, $classes['Zero']['methods']['anonymousFunction:7#28']['startLine']);
        $this->assertSame(9, $classes['Zero']['methods']['anonymousFunction:7#28']['endLine']);
    }
}
